...
//  findme
//
//  Created by ESPRIT on 17/04/2017.
...
class HADropDown: UIView {
    ...
    @objc private func didTap(gesture: UIGestureRecognizer) {
        ...
        if !isCollapsed {
            ...
            self.table.layer.borderWidth = 0
...
extension HADropDown : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        ahayalindex = selectedIndex
        SharedPref.sharedpref.setCircleIndex(index: ahayalindex)
        // Post notification
