<?php 
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if(isset($_POST['name']) and isset($_POST['news_id']) and isset($_FILES['image']['name']))
		{
			...
			try{
				...
				$sql = "INSERT INTO `admin_findme`.`images` (`id`, `url`, `name`,`news_id`) VALUES (NULL, '$file_url', '$name','$news_id');";
